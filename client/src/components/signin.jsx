  ...
  return (
    <div className="signup-container">
      ...
      <div className="form-section">
        ...
        <h2 className="welcome-title">Welcome back to Stackguard</h2>
        ...
        <form className="signup-form" onSubmit={onSubmit}>
          ...
          <div style={{ position: 'relative', width: '100%' }}>
            <input
              style={{ width: "93%", paddingRight: 44 }}
          ...
          <button style={{ width: "104%" }} type="submit" className="create-account-btn" disabled={loading}>
